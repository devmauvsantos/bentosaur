...
|---|---:|---:|
| Late Night Radio | -13.18 LUFS | -21 dB |
| Gentle Rain 01 | -27.43 LUFS | -22 dB |
...
lowered again after the second physical iPhone 17 Pro Max listening pass.
These gains remain an in-engine listening balance, not the final mix.
