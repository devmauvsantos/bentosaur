...
| Production stage | First playable loop complete; Home Menu V011 corrected, tested, captured, and running on the personal iPhone |
| Current blocker | Mau's V011 phone-scale visual/interaction approval, then founder playtest of the serving loop |
...
6. [Home Menu V011 registration corrections](checkpoints/2026-07-31-home-menu-v011-registration-corrections.md)
7. [Home Menu V010 complete modular stall kit](checkpoints/2026-07-31-home-menu-v010-complete-stall-kit.md)
8. [Home Menu V009 approved modular stall lanterns](checkpoints/2026-07-31-home-menu-v009-approved-stall-lanterns.md)
9. [Home Menu V008 linked reflections and stable anime coverage](checkpoints/2026-07-31-home-menu-v008-linked-reflections-and-filter-coverage.md)
10. [Home Menu V007 random living light](checkpoints/2026-07-31-home-menu-v007-random-living-light.md)
11. [Home Menu V006 guaranteed-light diagnostic](checkpoints/2026-07-31-home-menu-v006-guaranteed-light-diagnostic.md)
12. [Home Menu V005 failed device test](checkpoints/2026-07-31-home-menu-v005-device-motion-test.md)
13. [2D menu alternatives and idle proof](visual-explorations/2d-menu-alternatives-and-idle-proof-v3.md)
14. [2D flat-cel animation and screen proof](visual-explorations/2d-flat-cel-animation-and-screen-proof-v2.md)
15. [2D flat-cel production feasibility](visual-explorations/2d-flat-cel-production-feasibility-v1.md)
16. [Preserved live-3D engine lock](engine-decision-live-3d-godot-v1.md)
17. [Character production pipeline](character-production-pipeline-v1.md)
18. [Faceit and AI facial-animation strategy](facial-animation-faceit-ai-pipeline-v1.md)
19. [F0 r006 topology stop report](facial-topology-f0-r006-stop-report.md)
20. [Binary storage and recovery policy](character-binary-storage-policy-v1.md)
21. [3D/UI/animation ownership](hybrid-3d-ui-and-animation-ownership-v1.md)
...
- [x] Approve and promote the complete 32-texture V004 non-character stall
  attachment kit.
...
- [x] Export V010 with the personal Apple team and install/launch it on the
  physical iPhone.
- [x] Correct V010's crate, star-socket, and pot-lid registration failures;
  capture, test, and deploy V011 on the personal iPhone.
...
| Complete non-character stall kit | V011 registration correction installed; founder phone-scale approval pending | [Home Menu V011 checkpoint](checkpoints/2026-07-31-home-menu-v011-registration-corrections.md) |
