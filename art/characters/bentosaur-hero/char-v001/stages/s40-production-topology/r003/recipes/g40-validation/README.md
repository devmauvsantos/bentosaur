...
python3 .tmp/subagents/g40_validation_harness/g40_validate.py \
  ...
  --config .tmp/subagents/g40_validation_harness/configs/bentosaur_r003.sample.json \
  --output .tmp/subagents/g40_validation_harness/runs/my_fresh_r003_run
```
...
```bash
python3 .tmp/subagents/g40_validation_harness/tools/g40_artifacts.py \
  verify \
  --run .tmp/subagents/g40_validation_harness/runs/my_fresh_r003_run
```
...
python3 .tmp/subagents/g40_validation_harness/g40_validate.py \
  ...
  --output /Users/mauvsantos/Workspace/games/Bentosaur/.tmp/subagents/g40_validation_harness/runs/repaired_candidate_run \
